...
public final class OrganicTechBlocks{
	...
	public static final RegistryObject<Block> BLOOD = BLOCKS.register("blood", () -> new FlowingFluidBlock(OrganicTechFluids.BLOOD, Properties.create(Material.WATER).doesNotBlockMovement().hardnessAndResistance(100f).noDrops()));
